...
test("objectives system tests", async (t) => {
  ...
  await t.test("noteCollected", async (t) => {
    t.beforeEach(() => {
      resetRunState();
    });
    ...
    await t.test(
      "collecting an unrelated flower does not increment specific objective",
      () => {
        patchGameState({
          objectives: [
            {
    ...
    await t.test(
      "collecting a flower when max required is already reached does not increment",
      () => {
        patchGameState({
          objectives: [
            {
    ...
    await t.test(
      "collecting a flower updates the global game state (flowersCollected, objectives)",
      () => {
        patchGameState({
          objectives: [
            {
