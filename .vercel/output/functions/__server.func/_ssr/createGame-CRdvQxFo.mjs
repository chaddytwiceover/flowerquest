...
//#region node_modules/.nitro/vite/services/ssr/assets/createGame-CRdvQxFo.js
...
function updatePest(pest, options) {
...
function updateHazards(hazards, playerX = 0, playerY = 0, deltaSec = .016, isFrozen = false) {
	hazards.forEach((hazard) => updatePest(hazard, {
		playerX,
		playerY,
		deltaSec,
		isFrozen
